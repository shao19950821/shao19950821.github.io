...
var InitiateSparklineCharts = function () {
    return {
        init: function ($element) {
            ...
            /*Composite Bar*/
            var sparklinecompositebars =  $element ? $($element): $('[data-sparkline=compositebar]');
...
//add by wangwei 一个页面多个图表
var InitiateSparkline2Charts = function () {
    return {
        init: function (elementId) {
            /*Line*/
            var sparklinelines =  elementId ?  $("#"+elementId) : $('[data-sparkline=line2]');
            $.each(sparklinelines, function () {
                $(this).sparkline('html', {
                    type: 'line',
                    disableHiddenCheck: true,
