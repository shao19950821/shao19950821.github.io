(function() {
  ...
  Morris.Donut = (function(_super) {
    ...
    function Donut(options) {
      ...
      if (options.data === null || options.data === void 0 || options.data.length === 0) {
        this.noDataRender();
        return;
      }
      ...
      if(this.values.every(function(v){
            return v === 0;
          })){
        this.noDataRender();
        return ;
    ...
    Donut.prototype.noDataRender = function (){
      var html = '<h2 style="width:160px;text-align:center;margin:20px auto;">'+ this.options.noDataContent +'</h2>';
      this.el.html(html);
    }
